...
namespace PTSL.GENERIC.Api.Migrations
{
    ...
    [Migration("20240515184912_AttendedUserMeeting")]
    partial class AttendedUserMeeting
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PTSL.GENERIC.Common.Entity.Meeting.AttendedUserMeeting", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("SqtcUserId");

                    b.ToTable("AttendedUserMeeting", "GS");
                });

            modelBuilder.Entity("PTSL.GENERIC.Common.Entity.Meeting.Meeting", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("PTSL.GENERIC.Common.Entity.Meeting.AttendedUserMeeting", b =>
                {
                    b.HasOne("PTSL.GENERIC.Common.Entity.User", "ClientUser")
                        .WithMany()
                        .HasForeignKey("ClientuserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PTSL.GENERIC.Common.Entity.Meeting.Meeting", "Meeting")
                        .WithMany()
                        .HasForeignKey("MeetingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PTSL.GENERIC.Common.Entity.User", "SqtcUser")
                        .WithMany()
                        .HasForeignKey("SqtcUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
