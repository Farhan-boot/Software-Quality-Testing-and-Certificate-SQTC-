...
public sealed class FileHelper
{
    ...
    public static FileType GetFileType(IFormFile? file)
    {
        ...
        var imageExtensions = new string[] { ".png", ".jpg", ".jpeg", ".gif", ".avif", ".webp" };
        var documentExtensions = new string[] { ".doc", ".docx", ".xls", ".xlsx", ".pdf", ".txt" };
        var videoExtensions = new string[] { ".mp4", ".webm" };
    ...
    //All FIle Upload
    public (bool, string, string, string) SaveFileAll(IFormFile file, string directoryName, out string errorMessage)
    {
        if (file is null)
        {
            errorMessage = "File not found";
        ...
        errorMessage = string.Empty;
        return (true, publicFileUrl, file.FileName, newDiskFileName);
    }
